...
Route::group([
    ...
    Route::group(['prefix' => 'programs', 'middleware' => 'can:programs'], function () {
        ...
        Route::get('/porgram_courses/{id?}', 'ProgramsController@programCourses')
            ->name('admin.program.courses');
        Route::get('/get_porgram_courses', 'ProgramsController@getProgramCourses')
            ->name('admin.get.program.courses');
        Route::post('/store-new-program-course', 'ProgramsController@storeNewProgramCourse')
            ->name('admin.store.new.program.course');
        Route::post('/destroy-program-course', 'ProgramsController@destroyProgramCourse')
            ->name('admin.destroy.program.course');
        Route::post('/program-course-status', 'ProgramsController@changeProgramCourseStatus')
            ->name('admin.change.program.course.status');

        Route::get('/get-all-courses-name', 'ProgramsController@getAllCourseName')
            ->name('admin.get.all.courses.name');
    ...
    ///////////////////////////////////////////////////////////////////
    /// Drawings Routes
    Route::group(['prefix' => 'drawings', 'middleware' => 'can:talents'], function () {
        Route::get('/', 'DrawingsController@index')->name('admin.drawings');
        Route::get('/get-drawings', 'DrawingsController@getDrawings')->name('admin.get.drawings');
        Route::post('/store/mwhoob', 'DrawingsController@store')->name('admin.store.mwhoob.drawing');
        Route::post('/destroy', 'DrawingsController@destroy')->name('admin.destroy.drawing');
        Route::get('/get-all-mwhobs-name', 'DrawingsController@getAllMwhobName')
            ->name('admin.get.all.mwhobs.name');


        Route::get('/add/mwhoob/drawings/{id?}', 'DrawingsController@addMwhoobDrawings')
            ->name('admin.add.mwhoob.drawings');


        Route::post('/drawings/drag/drop/{mwhoobID?}', 'DrawingsController@uploadDrawings')
            ->name('admin.drawings.drag.drop');

        Route::post('/delete/drawing', 'DrawingsController@deleteUploadDrawing')
            ->name('admin.delete.drawing');
