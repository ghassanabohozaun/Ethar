...
class CourseLectureStatus extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'lecture:status';
     ...
     * @var string
     */
    protected $description = 'active and inactive course lecture at specific time';
    ...
    public function handle()
    {
        ...
        foreach ($Lectures as $lecture) {
            ...
            $lectureFromFormat = date('H:i', $lectureFrom);

            ////// lecture to
            $lectureTo = strtotime($lecture->lecture_to);
            $lectureToFormat = date('H:i', $lectureTo);
