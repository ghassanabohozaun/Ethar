<section class="about-section sec-pad" style="margin-top: 80px">
                ...
                <div class="image_block_1">
                    <div class="image-box">
                        <figure class="image image-1"><img
                                src="{!! asset('/site/assets/images/resource/about-1.png') !!}" alt=""></figure>
                        <figure class="image image-2"><img
                                src="{!! asset('/site/assets/images/resource/about-2.png') !!}" alt=""></figure>
                        <figure class="image image-3"><img src="{!! asset('/site/assets/images/icons/heart-2.png') !!}"
                                                           alt=""></figure>
                        <figure class="image image-4"><img src="{!! asset('/site/assets/images/icons/heart-3.png') !!}"
                                                           alt=""></figure>
                        <figure class="image image-5"><img src="{!! asset('/site/assets/images/icons/imoji-1.png') !!}"
                                                           alt=""></figure>
                    </div>
                </div>
            </div>
