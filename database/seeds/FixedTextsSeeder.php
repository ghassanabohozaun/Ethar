...
class FixedTextsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        FixedText::create([
            ...
            'counter_name_1_ar' =>$faker->word,
            'counter_name_1_en' =>$faker->word,
            'counter_icon_2' =>'charity-icon.jpg',
            'counter_number_2' =>$faker->numberBetween(0, 200),
            'counter_name_2_ar' =>$faker->word,
            'counter_name_2_en' =>$faker->word,
            'counter_icon_3' =>'charity-icon.jpg',
            'counter_number_3' =>$faker->numberBetween(0, 100),
            'counter_name_3_ar' =>$faker->word,
            'counter_name_3_en' =>$faker->word,
            'counter_icon_4' =>'charity-icon.jpg',
            'counter_number_4' =>$faker->numberBetween(0, 500),
            'counter_name_4_ar' =>$faker->word,
            'counter_name_4_en' =>$faker->word,
        ]);
    }
}
